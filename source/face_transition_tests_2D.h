...
public:
	...
	void showMesh();
	void showSubSurface();
	void showSubSurface2();
	void loadInitialMesh1();
	void loadInitialMesh2();
	void loadInitialMeshVertexVal3();
	void loadInitialMeshVertexVal8();
	...
	void evaluateTransitions();			//Check if the initial locations of the particles are right for the used mesh!
};
